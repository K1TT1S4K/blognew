  ...
  <link rel="stylesheet" href="{{asset('asset/backend/https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700&display=fallback')}}">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="{{asset('asset/backend/plugins/fontawesome-free/css/all.min.css')}}">
  <!-- Ionicons -->
  <link rel="stylesheet" href="{{asset('asset/backend/https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css')}}">
