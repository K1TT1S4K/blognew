                  ...
                  <div class="tab-pane active" id="settings">
                    <form wire:submit.prevent="UpdateProfile" class="form-horizontal">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" wire:model="lastname" class="form-control" id="inputName2" placeholder="Name">
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <textarea type="text" wire:model="phone_number" class="form-control" id="inputExperience" placeholder="Phone"></textarea>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputSkills" class="col-sm-2 col-form-label">Department</label>
                        <div class="col-sm-10">
                          <input type="text" wire:model="department" class="form-control" id="inputSkills" placeholder="Department">
                        </div>
                      </div>
                      <div class="form-group row">
